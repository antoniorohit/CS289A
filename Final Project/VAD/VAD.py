...
@author: https://github.com/shriphani/Listener/blob/master/VAD.py
'''
#!/usr/bin/env python
...
if __name__ == "__main__":
    ...
    a, b = VAD.moattar_homayounpour("/Users/antonio/git/caltranscense/models/data/test_protocol/android_helene_train_clean_21.wav", 0, 0)
    print VAD.moattar_homayounpour("/Users/antonio/git/caltranscense/models/data/test_protocol/android_helene_train_clean_21.wav", 40.06, 1)
    print VAD.moattar_homayounpour("/Users/antonio/git/caltranscense/models/data/test_protocol/android_helene_train_clean_21.wav", 32, 2)
    print VAD.moattar_homayounpour("/Users/antonio/git/caltranscense/models/data/test_protocol/android_helene_train_clean_21.wav", 21, 3)
