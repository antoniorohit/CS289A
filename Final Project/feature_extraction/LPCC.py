...
from lpcc_utils import cached_func, diff_feature
...
if __name__ == "__main__":
    extractor = LPCExtractor(44100, 32, 16, 23, 0.95)
    fs, signal = wavfile.read("/Users/antonio/git/caltranscense/models/data/test_protocol/android_helene_train_clean_21.wav")
    start = time.time()
